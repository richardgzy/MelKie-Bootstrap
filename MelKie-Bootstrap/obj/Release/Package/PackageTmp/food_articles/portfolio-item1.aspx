<asp:content id="portfolioItemContent" contentplaceholderid="ContentPlaceHolder1" runat="Server">
<head>
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Let's Explore Japanese Cuisine</h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
            <a href="../portfolio-1-col.aspx">Food Main Page</a>
                 </li>
            <li class="breadcrumb-item active">Japanese Cuisine</li>
        </ol>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <img class="img-fluid" src="japanese_food_1.jpg" alt="">
            </div>

            <div class="col-md-3">
                <img class="img-fluid" src="japanese_food_2.jpg" alt="">
            </div>

            <%--<div class="col-md-6">
                <h3 class="my-3">Project Description</h3>
                <p>Japanese cuisine offers an abundance of gastronomical delights with a boundless variety of regional and seasonal dishes as well as international cuisine. Two of the most popular Japanese cuisine are Ramen and Sashimi. 
...
Sashimi is thinly sliced, raw food. It is one of the most famous dishes in the Japanese cuisine. Seafood is most commonly eaten as sashimi, but other types of meats (such as beef, horse and deer) and foods (such as yuba tofu skin and konnyaku) can also be served as sashimi. Some people confuse sashimi with sushi. Unlike sashimi, sushi includes vinegared rice. Depending on the type of sashimi, a little bit of wasabi or ground ginger may be added to the sashimi piece. </p>
